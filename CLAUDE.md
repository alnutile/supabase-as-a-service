...
- **Tables (Airtable-but-real-Postgres):** `TablesPage` (route `/tables`, sidebar,
  ...
  **Public write-forms (migration 0109):** a table can accept ANONYMOUS submissions (a
