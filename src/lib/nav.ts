  ...
  },
  {
    ...
    items: [
      ...
      { to: '/links', label: 'Links', key: 'links', icon: LinkIcon, keywords: 'bookmarks' },
      {
        ...
        key: 'repositories',
        icon: RepoIcon,
        keywords: 'github git code repo source codebase products what we build',
      },
      {
        to: '/whiteboards',
        label: 'Whiteboards',
      ...
      },
      {
        ...
        key: 'card-boards',
        icon: CardsIcon,
        keywords: 'card board sticky notes ideas priority brainstorm plan free-form',
      },
      { to: '/memory', label: 'Memory', key: 'memory', icon: MemoryIcon, keywords: 'remember preferences personalization profile context' },
      { to: '/meeting-notes', label: 'Meeting Notes', key: 'meeting-notes', icon: MicIcon, keywords: 'record transcribe audio voice stt speech meeting minutes' },
...
export const settingsGroup: NavGroup = {
  ...
  items: [
    ...
    { to: '/settings/github', label: 'GitHub', key: 'settings.github', icon: RepoIcon, adminOnly: true, alwaysOn: true, keywords: 'settings github token repositories code private repo' },
