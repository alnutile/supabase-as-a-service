...
// password, Fastmail, a work IMAP server) and a cron-ticked edge function polls
// it into the unified inbox. The password is write-only: it lives in Vault,
// written through set_imap_account; the row only ever exposes non-secret config.
type ImapAccount = {
  id: string
  label: string
  host: string
